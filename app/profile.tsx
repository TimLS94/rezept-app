...
const styles = StyleSheet.create({
  ...
  dollarSign: { fontSize: 24, fontWeight: '700', color: '#FF6B35', marginRight: 4 },
  ...
  memberPortion: { fontSize: 12, color: '#FF6B35', marginTop: 4 },
  ...
  creatorSubtitle: { fontSize: 13, color: '#FF6B35' },
  creatorArrow: { fontSize: 20, color: '#FF6B35' },
  ...
  genderButtonActive: { backgroundColor: '#FF6B35' },
  ...
  dietaryChipTextActive: { color: '#FF6B35', fontWeight: '600' },
