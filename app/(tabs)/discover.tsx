...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontFamily: 'Anton_400Regular', fontSize: 20, color: '#FFFFFF', letterSpacing: 0.3 },
  likedBadge: { backgroundColor: 'rgba(255,255,255,0.12)', paddingHorizontal: 12, paddingVertical: 6, borderRadius: 16, minWidth: 56, alignItems: 'center' },
  likedBadgeText: { fontSize: 14, fontWeight: '600', color: '#FFFFFF' },
  filterRow: { paddingHorizontal: 16, paddingVertical: 8, gap: 8 },
  filterChip: { paddingHorizontal: 14, paddingVertical: 8, borderRadius: 20, backgroundColor: 'transparent', marginRight: 8, borderWidth: 1, borderColor: 'rgba(255,255,255,0.28)' },
  filterChipActive: { backgroundColor: '#F2701E', borderColor: '#F2701E' },
  filterChipText: { fontSize: 13, color: 'rgba(255,255,255,0.82)', fontWeight: '500' },
  filterChipTextActive: { color: '#FFF', fontWeight: '600' },
  cardArea: { flex: 1, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 16 },
  card: { position: 'absolute', width: width - 32, height: '92%', borderRadius: 24, backgroundColor: '#16263C', overflow: 'hidden', shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.15, shadowRadius: 12, elevation: 6 },
  ...
  likeStamp: { left: 24, borderColor: '#3C8D40', transform: [{ rotate: '-18deg' }] },
  likeStampText: { color: '#3C8D40', fontSize: 32, fontWeight: '800' },
  ...
  primaryButton: { backgroundColor: '#F2701E', paddingHorizontal: 24, paddingVertical: 16, borderRadius: 14, marginTop: 8 },
