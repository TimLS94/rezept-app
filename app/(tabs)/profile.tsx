...
const styles = StyleSheet.create({
  ...
  statNumber: { fontSize: 24, fontWeight: '700', color: '#F2701E' },
  ...
  dollarSign: { fontSize: 24, fontWeight: '700', color: '#F2701E', marginRight: 4 },
  ...
  memberPortion: { fontSize: 12, color: '#F2701E', marginTop: 4 },
  ...
  genderButtonActive: { backgroundColor: '#F2701E' },
  ...
  dietaryChipTextActive: { color: '#F2701E', fontWeight: '600' },
  ...
  saveButton: { flex: 1, padding: 14, borderRadius: 10, backgroundColor: '#F2701E', alignItems: 'center' },
  saveButtonText: { fontSize: 16, fontWeight: '600', color: '#FFF' },
  // Creator profile styles
  editLink: { fontSize: 14, color: '#F2701E', fontWeight: '600' },
  bioInput: { backgroundColor: '#F5F5F5', borderRadius: 12, padding: 16, fontSize: 15, minHeight: 100, textAlignVertical: 'top' },
  saveBioButton: { backgroundColor: '#F2701E', padding: 14, borderRadius: 10, alignItems: 'center', marginTop: 12 },
  ...
  categoryChipText: { fontSize: 13, color: '#F2701E', fontWeight: '600' },
  ...
  uploadFirstButton: { backgroundColor: '#F2701E', paddingHorizontal: 20, paddingVertical: 12, borderRadius: 12 },
