...
const styles = StyleSheet.create({
  ...
  addAll: { fontSize: 13, color: '#F2701E', fontWeight: '700' },
  ...
  actCook: { width: 36, height: 36, borderRadius: 18, backgroundColor: '#F2701E', justifyContent: 'center', alignItems: 'center' },
  ...
  discoverButton: { backgroundColor: '#F2701E', paddingHorizontal: 24, paddingVertical: 14, borderRadius: 14, marginTop: 20 },
